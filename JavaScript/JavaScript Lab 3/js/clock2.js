...
let secondMarkLength = hourMarkLength / 2;
document
...
function drawMSecondHand(second) {
  context.save();
  context.translate(clockOriginX, clockOriginY);
...
function drawUserTime() {
  ...
  let seconds = document.getElementById("secondInput").value;
